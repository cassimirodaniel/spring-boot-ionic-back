...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DataIntegrationExecption.class)
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrationExecption e, HttpServletRequest request){
